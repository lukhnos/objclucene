 ...
 */
inline OrgApacheLuceneDocumentFieldType *OrgApacheLuceneDocumentLongField_get_TYPE_NOT_STORED(void);
...
/*!
 @brief Type for a stored LongField:
  normalization factors, frequencies, and positions are omitted.
 */
inline OrgApacheLuceneDocumentFieldType *OrgApacheLuceneDocumentLongField_get_TYPE_STORED(void);
/*! INTERNAL ONLY - Use accessor function from above. */
