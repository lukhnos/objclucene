...
/*!
 @brief Unicode collation support.
 <p>
 ...
 <ul>
    ...
    <li>
      ...
      <code>org.apache.lucene.analysis.miscellaneous.ASCIIFoldingFilter</code> provide these services
 ...
 <h3>Farsi Range Queries</h3>
  <pre class="prettyprint">
    ...
    Document doc = new Document();   doc.add(new TextField("content", "ساب", Field.Store.YES));
...
@endcode
 ...
 <h3>Danish Sorting</h3>
  <pre class="prettyprint">
    ...
    String[] tracer = new String[] { "A", "B", "C", "D", "E" };   String[] data = new String[] { "HAT", "HUT", "HÅT", "HØT", "HOT" };
...
@endcode
 ...
 <h3>Turkish Case Normalization</h3>
  <pre class="prettyprint">
    ...
    IndexReader ir = DirectoryReader.open(ramDir);
    IndexSearcher is = new IndexSearcher(ir);
    QueryParser parser = new QueryParser("contents", analyzer);   Query query = parser.parse("dıgy");   // U+0131: dotless i
...
@endcode
 ...
 <h2>Caveats and Comparisons</h2>
  <p>
    ...
    the same <code>Collator</code>.  Since <code>java.text.RuleBasedCollator</code>s
 ...
 <code>java.text.Collator.getInstance(java.util.Locale)</code>.
    </li>
    <li>
      The collation strength used - see <code>java.text.Collator.setStrength(int)</code>
    </li>
  </ol>  
 <p>
...
#pragma push_macro("INCLUDE_ALL_OrgApacheLuceneCollationPackage_info")
#ifdef RESTRICT_OrgApacheLuceneCollationPackage_info
#define INCLUDE_ALL_OrgApacheLuceneCollationPackage_info 0
#else
#define INCLUDE_ALL_OrgApacheLuceneCollationPackage_info 1
#endif
#undef RESTRICT_OrgApacheLuceneCollationPackage_info
...
#endif
#pragma pop_macro("INCLUDE_ALL_OrgApacheLuceneCollationPackage_info")
