...
FOUNDATION_EXPORT void OrgApacheLuceneAnalysisPtPortugueseMinimalStemFilterFactory_init(OrgApacheLuceneAnalysisPtPortugueseMinimalStemFilterFactory *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisPtPortugueseMinimalStemFilterFactory *new_OrgApacheLuceneAnalysisPtPortugueseMinimalStemFilterFactory_init() NS_RETURNS_RETAINED;
