 ...
 */
inline NSString *OrgApacheLuceneAnalysisDaDanishAnalyzer_get_DEFAULT_STOPWORD_FILE();
...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisDaDanishAnalyzer *create_OrgApacheLuceneAnalysisDaDanishAnalyzer_init();
