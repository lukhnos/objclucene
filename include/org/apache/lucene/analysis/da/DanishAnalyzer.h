...
#pragma push_macro("INCLUDE_ALL_OrgApacheLuceneAnalysisDaDanishAnalyzer")
#ifdef RESTRICT_OrgApacheLuceneAnalysisDaDanishAnalyzer
#define INCLUDE_ALL_OrgApacheLuceneAnalysisDaDanishAnalyzer 0
#else
#define INCLUDE_ALL_OrgApacheLuceneAnalysisDaDanishAnalyzer 1
#endif
#undef RESTRICT_OrgApacheLuceneAnalysisDaDanishAnalyzer
...
#if !defined (OrgApacheLuceneAnalysisDaDanishAnalyzer_) && (INCLUDE_ALL_OrgApacheLuceneAnalysisDaDanishAnalyzer || defined(INCLUDE_OrgApacheLuceneAnalysisDaDanishAnalyzer))
#define OrgApacheLuceneAnalysisDaDanishAnalyzer_
...
/*!
 @brief <code>Analyzer</code> for Danish.
 */
...
/*!
 @brief File containing default Danish stopwords.
 */
inline NSString *OrgApacheLuceneAnalysisDaDanishAnalyzer_get_DEFAULT_STOPWORD_FILE(void);
/*! INTERNAL ONLY - Use accessor function from above. */
FOUNDATION_EXPORT NSString *OrgApacheLuceneAnalysisDaDanishAnalyzer_DEFAULT_STOPWORD_FILE;
J2OBJC_STATIC_FIELD_OBJ_FINAL(OrgApacheLuceneAnalysisDaDanishAnalyzer, DEFAULT_STOPWORD_FILE, NSString *)

FOUNDATION_EXPORT OrgApacheLuceneAnalysisUtilCharArraySet *OrgApacheLuceneAnalysisDaDanishAnalyzer_getDefaultStopSet(void);

FOUNDATION_EXPORT void OrgApacheLuceneAnalysisDaDanishAnalyzer_init(OrgApacheLuceneAnalysisDaDanishAnalyzer *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisDaDanishAnalyzer *new_OrgApacheLuceneAnalysisDaDanishAnalyzer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneAnalysisDaDanishAnalyzer *create_OrgApacheLuceneAnalysisDaDanishAnalyzer_init(void);
...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisDaDanishAnalyzer *create_OrgApacheLuceneAnalysisDaDanishAnalyzer_initWithOrgApacheLuceneAnalysisUtilCharArraySet_(OrgApacheLuceneAnalysisUtilCharArraySet *stopwords);
...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisDaDanishAnalyzer *create_OrgApacheLuceneAnalysisDaDanishAnalyzer_initWithOrgApacheLuceneAnalysisUtilCharArraySet_withOrgApacheLuceneAnalysisUtilCharArraySet_(OrgApacheLuceneAnalysisUtilCharArraySet *stopwords, OrgApacheLuceneAnalysisUtilCharArraySet *stemExclusionSet);
...
#endif
#pragma pop_macro("INCLUDE_ALL_OrgApacheLuceneAnalysisDaDanishAnalyzer")
