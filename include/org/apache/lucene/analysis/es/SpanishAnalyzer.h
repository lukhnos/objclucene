 ...
 */
inline NSString *OrgApacheLuceneAnalysisEsSpanishAnalyzer_get_DEFAULT_STOPWORD_FILE(void);
...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisUtilCharArraySet *OrgApacheLuceneAnalysisEsSpanishAnalyzer_getDefaultStopSet(void);

FOUNDATION_EXPORT void OrgApacheLuceneAnalysisEsSpanishAnalyzer_init(OrgApacheLuceneAnalysisEsSpanishAnalyzer *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisEsSpanishAnalyzer *new_OrgApacheLuceneAnalysisEsSpanishAnalyzer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneAnalysisEsSpanishAnalyzer *create_OrgApacheLuceneAnalysisEsSpanishAnalyzer_init(void);
