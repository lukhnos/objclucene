...
FOUNDATION_EXPORT void OrgApacheLuceneAnalysisMiscellaneousCodepointCountFilter_init(OrgApacheLuceneAnalysisMiscellaneousCodepointCountFilter *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisMiscellaneousCodepointCountFilter *new_OrgApacheLuceneAnalysisMiscellaneousCodepointCountFilter_init() NS_RETURNS_RETAINED;
