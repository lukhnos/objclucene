...
FOUNDATION_EXPORT void OrgApacheLuceneAnalysisMiscellaneousScandinavianFoldingFilter_init(OrgApacheLuceneAnalysisMiscellaneousScandinavianFoldingFilter *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisMiscellaneousScandinavianFoldingFilter *new_OrgApacheLuceneAnalysisMiscellaneousScandinavianFoldingFilter_init() NS_RETURNS_RETAINED;
