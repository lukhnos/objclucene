...
FOUNDATION_EXPORT void OrgApacheLuceneAnalysisMiscellaneousLimitTokenCountFilterFactory_init(OrgApacheLuceneAnalysisMiscellaneousLimitTokenCountFilterFactory *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisMiscellaneousLimitTokenCountFilterFactory *new_OrgApacheLuceneAnalysisMiscellaneousLimitTokenCountFilterFactory_init() NS_RETURNS_RETAINED;
