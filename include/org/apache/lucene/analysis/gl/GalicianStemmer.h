...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisGlGalicianStemmer *new_OrgApacheLuceneAnalysisGlGalicianStemmer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneAnalysisGlGalicianStemmer *create_OrgApacheLuceneAnalysisGlGalicianStemmer_init(void);
