 ...
 */
inline NSString *OrgApacheLuceneAnalysisHuHungarianAnalyzer_get_DEFAULT_STOPWORD_FILE();
...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisHuHungarianAnalyzer *create_OrgApacheLuceneAnalysisHuHungarianAnalyzer_init();
