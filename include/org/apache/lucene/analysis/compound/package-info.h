...
/*!
 @brief A filter that decomposes compound words you find in many Germanic
 ...
 <table border="1" summary="example input stream">
  ...
  The input token is always preserved and the filters do not alter the case of word parts.
 ...
 <h3>Compound word token filters</h3>
  ...
  The <code>HyphenationCompoundWordTokenFilter</code>
 ...
 <h4>DictionaryCompoundWordTokenFilter</h4>
  The <code>DictionaryCompoundWordTokenFilter</code>
...
#pragma push_macro("INCLUDE_ALL_OrgApacheLuceneAnalysisCompoundPackage_info")
#ifdef RESTRICT_OrgApacheLuceneAnalysisCompoundPackage_info
#define INCLUDE_ALL_OrgApacheLuceneAnalysisCompoundPackage_info 0
#else
#define INCLUDE_ALL_OrgApacheLuceneAnalysisCompoundPackage_info 1
#endif
#undef RESTRICT_OrgApacheLuceneAnalysisCompoundPackage_info
...
#endif
#pragma pop_macro("INCLUDE_ALL_OrgApacheLuceneAnalysisCompoundPackage_info")
