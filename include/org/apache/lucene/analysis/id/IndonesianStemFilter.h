...
FOUNDATION_EXPORT void OrgApacheLuceneAnalysisIdIndonesianStemFilter_init(OrgApacheLuceneAnalysisIdIndonesianStemFilter *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisIdIndonesianStemFilter *new_OrgApacheLuceneAnalysisIdIndonesianStemFilter_init() NS_RETURNS_RETAINED;
