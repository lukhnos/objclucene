...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisFiFinnishLightStemmer *new_OrgApacheLuceneAnalysisFiFinnishLightStemmer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneAnalysisFiFinnishLightStemmer *create_OrgApacheLuceneAnalysisFiFinnishLightStemmer_init(void);
