 ...
 */
inline NSString *OrgApacheLuceneAnalysisFiFinnishAnalyzer_get_DEFAULT_STOPWORD_FILE(void);
...
FOUNDATION_EXPORT OrgApacheLuceneAnalysisUtilCharArraySet *OrgApacheLuceneAnalysisFiFinnishAnalyzer_getDefaultStopSet(void);

FOUNDATION_EXPORT void OrgApacheLuceneAnalysisFiFinnishAnalyzer_init(OrgApacheLuceneAnalysisFiFinnishAnalyzer *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisFiFinnishAnalyzer *new_OrgApacheLuceneAnalysisFiFinnishAnalyzer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneAnalysisFiFinnishAnalyzer *create_OrgApacheLuceneAnalysisFiFinnishAnalyzer_init(void);
