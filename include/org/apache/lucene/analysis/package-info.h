...
/*!
 ...
 create an anonymous subclass of <code>org.apache.lucene.analysis.Analyzer</code>, provide <code>org.apache.lucene.analysis.Analyzer.createComponents(String)</code>
  and perhaps also
 <code>org.apache.lucene.analysis.Analyzer.initReader(String,java.io.Reader)</code>
 ...
 * (&lt; min) or too long (&gt; max).
 * &commat;&commat;param version the Lucene match version
 * &commat;&commat;param in      the TokenStream to consume
 * &commat;&commat;param min     the minimum length
 * &commat;&commat;param max     the maximum length
 *&#47;
