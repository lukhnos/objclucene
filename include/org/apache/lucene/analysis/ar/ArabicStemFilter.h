...
FOUNDATION_EXPORT void OrgApacheLuceneAnalysisArArabicStemFilter_init(OrgApacheLuceneAnalysisArArabicStemFilter *self);

FOUNDATION_EXPORT OrgApacheLuceneAnalysisArArabicStemFilter *new_OrgApacheLuceneAnalysisArArabicStemFilter_init() NS_RETURNS_RETAINED;
