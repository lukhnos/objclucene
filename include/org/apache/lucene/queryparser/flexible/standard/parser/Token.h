...
FOUNDATION_EXPORT OrgApacheLuceneQueryparserFlexibleStandardParserToken *new_OrgApacheLuceneQueryparserFlexibleStandardParserToken_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneQueryparserFlexibleStandardParserToken *create_OrgApacheLuceneQueryparserFlexibleStandardParserToken_init(void);
