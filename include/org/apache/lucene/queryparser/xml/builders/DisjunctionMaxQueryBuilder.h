...
FOUNDATION_EXPORT void OrgApacheLuceneQueryparserXmlBuildersDisjunctionMaxQueryBuilder_init(OrgApacheLuceneQueryparserXmlBuildersDisjunctionMaxQueryBuilder *self);

FOUNDATION_EXPORT OrgApacheLuceneQueryparserXmlBuildersDisjunctionMaxQueryBuilder *new_OrgApacheLuceneQueryparserXmlBuildersDisjunctionMaxQueryBuilder_init() NS_RETURNS_RETAINED;
