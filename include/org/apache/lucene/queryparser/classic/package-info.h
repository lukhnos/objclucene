...
/*!
 @brief A simple query parser implemented with JavaCC.
 ...
 <p><b>NOTE</b>: <code>org.apache.lucene.queryparser.flexible.standard</code> has an alternative queryparser that matches the syntax of this one, but is more modular,
 ...
 <pre class="code">title:"The Right Way" AND text:go
@endcode
  <p>or
  <pre class="code">title:"The Right Way" AND go
@endcode
 ...
 <pre class="code">title:The Right Way
@endcode
...
@endcode
 ...
 <a name="Regexp_Searches"></a>
  ...
  syntax is documented in the <code>RegExp</code> class. For example to find documents containing "moat" or "boat":  
 <pre class="code">/[mb]oat/
@endcode
...
@endcode
 ...
 <pre class="code">"jakarta apache"~10
@endcode
 ...
 <pre class="code">mod_date:[20020101 TO 20030101]
@endcode
 ...
 <pre class="code">title:{Aida TO Carmen}
@endcode
...
@endcode
 ...
 <pre class="code">"jakarta apache" jakarta
@endcode
  <p>or
  <pre class="code">"jakarta apache" OR jakarta
@endcode
 ...
 <pre class="code">"jakarta apache" AND "Apache Lucene"
@endcode
  <a name="N10126"></a>
  <h3 class="boxed">+</h3>
...
@endcode
 ...
 <pre class="code">(jakarta OR apache) AND website
@endcode
 ...
 <pre class="code">title:(+return +"pink panther")
@endcode
  </div>
 ...
 <pre class="code">\(1\+1\)\:2
@endcode
  </div>
 */
#include "J2ObjC_header.h"

#pragma push_macro("INCLUDE_ALL_OrgApacheLuceneQueryparserClassicPackage_info")
#ifdef RESTRICT_OrgApacheLuceneQueryparserClassicPackage_info
#define INCLUDE_ALL_OrgApacheLuceneQueryparserClassicPackage_info 0
#else
#define INCLUDE_ALL_OrgApacheLuceneQueryparserClassicPackage_info 1
#endif
#undef RESTRICT_OrgApacheLuceneQueryparserClassicPackage_info
...
#endif
#pragma pop_macro("INCLUDE_ALL_OrgApacheLuceneQueryparserClassicPackage_info")
