...
FOUNDATION_EXPORT void OrgApacheLuceneUtilPackedBulkOperationPacked4_initPackagePrivate(OrgApacheLuceneUtilPackedBulkOperationPacked4 *self);

FOUNDATION_EXPORT OrgApacheLuceneUtilPackedBulkOperationPacked4 *new_OrgApacheLuceneUtilPackedBulkOperationPacked4_initPackagePrivate(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgApacheLuceneUtilPackedBulkOperationPacked4 *create_OrgApacheLuceneUtilPackedBulkOperationPacked4_initPackagePrivate(void);
