...
FOUNDATION_EXPORT void OrgApacheLuceneSearchSuggestLookup_LookupPriorityQueue_init(OrgApacheLuceneSearchSuggestLookup_LookupPriorityQueue *self);

FOUNDATION_EXPORT OrgApacheLuceneSearchSuggestLookup_LookupPriorityQueue *new_OrgApacheLuceneSearchSuggestLookup_LookupPriorityQueue_init() NS_RETURNS_RETAINED;
