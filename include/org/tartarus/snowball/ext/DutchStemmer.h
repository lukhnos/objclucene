...
FOUNDATION_EXPORT OrgTartarusSnowballExtDutchStemmer *new_OrgTartarusSnowballExtDutchStemmer_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgTartarusSnowballExtDutchStemmer *create_OrgTartarusSnowballExtDutchStemmer_init(void);
