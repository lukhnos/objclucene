...
OrgApacheLuceneDocumentFieldType *OrgApacheLuceneBkdtreeBKDPointField_TYPE_;
...
+ (void)initialize {
  if (self == [OrgApacheLuceneBkdtreeBKDPointField class]) {
    JreStrongAssignAndConsume(&OrgApacheLuceneBkdtreeBKDPointField_TYPE_, new_OrgApacheLuceneDocumentFieldType_init());
    {
      [OrgApacheLuceneBkdtreeBKDPointField_TYPE_ setDocValuesTypeWithOrgApacheLuceneIndexDocValuesTypeEnum:JreLoadStatic(OrgApacheLuceneIndexDocValuesTypeEnum, SORTED_NUMERIC)];
      [OrgApacheLuceneBkdtreeBKDPointField_TYPE_ freeze];
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "TYPE_", NULL, 0x19, "Lorg.apache.lucene.document.FieldType;", &OrgApacheLuceneBkdtreeBKDPointField_TYPE_, NULL, .constantValue.asLong = 0 },
  };
