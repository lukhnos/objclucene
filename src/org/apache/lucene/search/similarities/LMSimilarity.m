...
- (OrgApacheLuceneSearchSimilaritiesBasicStats *)newStatsWithNSString:(NSString *)field
  ...
  return [new_OrgApacheLuceneSearchSimilaritiesLMSimilarity_LMStats_initWithNSString_withFloat_(field, queryBoost) autorelease];
}
...
- (void)fillBasicStatsWithOrgApacheLuceneSearchSimilaritiesBasicStats:(OrgApacheLuceneSearchSimilaritiesBasicStats *)stats
  ...
  OrgApacheLuceneSearchSimilaritiesLMSimilarity_LMStats *lmStats = (OrgApacheLuceneSearchSimilaritiesLMSimilarity_LMStats *) check_class_cast(stats, [OrgApacheLuceneSearchSimilaritiesLMSimilarity_LMStats class]);
...
- (NSString *)description {
  ...
  if (coll != nil) {
    return NSString_formatWithJavaUtilLocale_withNSString_withNSObjectArray_(JreLoadStatic(JavaUtilLocale, ROOT_), @"LM %s - %s", [IOSObjectArray arrayWithObjects:(id[]){ [self getName], coll } count:2 type:NSObject_class_()]);
  }
  else {
    return NSString_formatWithJavaUtilLocale_withNSString_withNSObjectArray_(JreLoadStatic(JavaUtilLocale, ROOT_), @"LM %s", [IOSObjectArray arrayWithObjects:(id[]){ [self getName] } count:1 type:NSObject_class_()]);
  }
}
...
void OrgApacheLuceneSearchSimilaritiesLMSimilarity_init(OrgApacheLuceneSearchSimilaritiesLMSimilarity *self) {
  OrgApacheLuceneSearchSimilaritiesLMSimilarity_initWithOrgApacheLuceneSearchSimilaritiesLMSimilarity_CollectionModel_(self, [new_OrgApacheLuceneSearchSimilaritiesLMSimilarity_DefaultCollectionModel_init() autorelease]);
}
