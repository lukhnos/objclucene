...
J2OBJC_STATIC_FIELD_GETTER(OrgApacheLuceneSearchSuggestJaspellJaspellLookup, LO_KID, jbyte)

J2OBJC_STATIC_FIELD_GETTER(OrgApacheLuceneSearchSuggestJaspellJaspellLookup, EQ_KID, jbyte)

J2OBJC_STATIC_FIELD_GETTER(OrgApacheLuceneSearchSuggestJaspellJaspellLookup, HI_KID, jbyte)

J2OBJC_STATIC_FIELD_GETTER(OrgApacheLuceneSearchSuggestJaspellJaspellLookup, HAS_VALUE, jbyte)
...
- (void)buildWithOrgApacheLuceneSearchSuggestInputIterator:(id<OrgApacheLuceneSearchSuggestInputIterator>)iterator {
  ...
  while ((spare = [iterator next]) != nil) {
    ...
    [trie_ putWithJavaLangCharSequence:[charsSpare description] withId:JavaLangLong_valueOfWithLong_(weight)];
    count_++;
  }
}
...
- (id<JavaUtilList>)lookupWithJavaLangCharSequence:(id<JavaLangCharSequence>)key
  ...
  if (onlyMorePopular) {
    ...
    for (NSString * __strong s in list) {
      jlong freq = [((NSNumber *) nil_chk(((NSNumber *) check_class_cast([((OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie *) nil_chk(trie_)) getWithJavaLangCharSequence:s], [NSNumber class])))) longLongValue];
      [queue insertWithOverflowWithId:[new_OrgApacheLuceneSearchSuggestLookup_LookupResult_initWithJavaLangCharSequence_withLong_([new_OrgApacheLuceneUtilCharsRef_initWithNSString_(s) autorelease], freq) autorelease]];
    }
    {
    ...
    for (jint i = 0; i < maxCnt; i++) {
      ...
      jlong freq = [((NSNumber *) nil_chk(((NSNumber *) check_class_cast([((OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie *) nil_chk(trie_)) getWithJavaLangCharSequence:s], [NSNumber class])))) longLongValue];
      [res addWithId:[new_OrgApacheLuceneSearchSuggestLookup_LookupResult_initWithJavaLangCharSequence_withLong_([new_OrgApacheLuceneUtilCharsRef_initWithNSString_(s) autorelease], freq) autorelease]];
    }
  }
  return res;
}
...
- (jboolean)load__WithOrgApacheLuceneStoreDataInput:(OrgApacheLuceneStoreDataInput *)input {
  ...
  OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode *root = [new_OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode_initWithOrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_withChar_withOrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode_(trie_, 0x0000, nil) autorelease];
...
void OrgApacheLuceneSearchSuggestJaspellJaspellLookup_readRecursivelyWithOrgApacheLuceneStoreDataInput_withOrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode_(OrgApacheLuceneSearchSuggestJaspellJaspellLookup *self, OrgApacheLuceneStoreDataInput *inArg, OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode *node) {
  ...
  if ((mask & OrgApacheLuceneSearchSuggestJaspellJaspellLookup_LO_KID) != 0) {
    OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode *kid = [new_OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode_initWithOrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_withChar_withOrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode_(self->trie_, 0x0000, node) autorelease];
...
void OrgApacheLuceneSearchSuggestJaspellJaspellLookup_writeRecursivelyWithOrgApacheLuceneStoreDataOutput_withOrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode_(OrgApacheLuceneSearchSuggestJaspellJaspellLookup *self, OrgApacheLuceneStoreDataOutput *outArg, OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode *node) {
  ...
  [((OrgApacheLuceneStoreDataOutput *) nil_chk(outArg)) writeStringWithNSString:[NSString stringWithCharacters:[IOSCharArray arrayWithChars:(jchar[]){ ((OrgApacheLuceneSearchSuggestJaspellJaspellTernarySearchTrie_TSTNode *) nil_chk(node))->splitchar_ } count:1] offset:0 length:1]];
  jbyte mask = 0;
  ...
  if (node->data_ != nil) {
    [outArg writeLongWithLong:[((NSNumber *) check_class_cast(node->data_, [NSNumber class])) longLongValue]];
  }
