...
@interface OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader () {
 @public
...
J2OBJC_FIELD_SETTER(OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader, fields_, JavaUtilTreeMap *)

__attribute__((unused)) static OrgApacheLuceneUtilBytesRef *OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_readBytesRefWithOrgApacheLuceneStoreIndexInput_(OrgApacheLuceneStoreIndexInput *inArg);

__attribute__((unused)) static void OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_seekDirWithOrgApacheLuceneStoreIndexInput_(OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader *self, OrgApacheLuceneStoreIndexInput *input);

@implementation OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader
...
- (instancetype)initWithOrgApacheLuceneCodecsPostingsReaderBase:(OrgApacheLuceneCodecsPostingsReaderBase *)postingsReader
  ...
  OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_initWithOrgApacheLuceneCodecsPostingsReaderBase_withOrgApacheLuceneIndexSegmentReadState_(self, postingsReader, state);
  return self;
}

+ (OrgApacheLuceneUtilBytesRef *)readBytesRefWithOrgApacheLuceneStoreIndexInput:(OrgApacheLuceneStoreIndexInput *)inArg {
  return OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_readBytesRefWithOrgApacheLuceneStoreIndexInput_(inArg);
}

- (void)seekDirWithOrgApacheLuceneStoreIndexInput:(OrgApacheLuceneStoreIndexInput *)input {
  OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_seekDirWithOrgApacheLuceneStoreIndexInput_(self, input);
}
...
- (OrgApacheLuceneIndexTerms *)termsWithNSString:(NSString *)field {
  JreAssert((field != nil), (@"org/apache/lucene/codecs/blocktreeords/OrdsBlockTreeTermsReader.java:203 condition failed: assert field != null;"));
...
- (jlong)ramBytesUsed {
  ...
  for (OrgApacheLuceneCodecsBlocktreeordsOrdsFieldReader * __strong reader in nil_chk([((JavaUtilTreeMap *) nil_chk(fields_)) values])) {
    sizeInBytes += [((OrgApacheLuceneCodecsBlocktreeordsOrdsFieldReader *) nil_chk(reader)) ramBytesUsed];
  }
  return sizeInBytes;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithOrgApacheLuceneCodecsPostingsReaderBase:withOrgApacheLuceneIndexSegmentReadState:", "OrdsBlockTreeTermsReader", NULL, 0x1, "Ljava.io.IOException;", NULL },
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "fields_", NULL, 0x12, "Ljava.util.TreeMap;", NULL, "Ljava/util/TreeMap<Ljava/lang/String;Lorg/apache/lucene/codecs/blocktreeords/OrdsFieldReader;>;", .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader = { 2, "OrdsBlockTreeTermsReader", "org.apache.lucene.codecs.blocktreeords", NULL, 0x11, 12, methods, 3, fields, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader;
}
...
void OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_initWithOrgApacheLuceneCodecsPostingsReaderBase_withOrgApacheLuceneIndexSegmentReadState_(OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader *self, OrgApacheLuceneCodecsPostingsReaderBase *postingsReader, OrgApacheLuceneIndexSegmentReadState *state) {
  ...
  NSString *termsFile = OrgApacheLuceneIndexIndexFileNames_segmentFileNameWithNSString_withNSString_withNSString_(((OrgApacheLuceneIndexSegmentInfo *) nil_chk(((OrgApacheLuceneIndexSegmentReadState *) nil_chk(state))->segmentInfo_))->name_, state->segmentSuffix_, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_TERMS_EXTENSION_);
  ...
  @try {
    jint version_ = OrgApacheLuceneCodecsCodecUtil_checkIndexHeaderWithOrgApacheLuceneStoreDataInput_withNSString_withInt_withInt_withByteArray_withNSString_(self->in_, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_TERMS_CODEC_NAME_, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_VERSION_START, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_VERSION_CURRENT, [state->segmentInfo_ getId], state->segmentSuffix_);
    NSString *indexFile = OrgApacheLuceneIndexIndexFileNames_segmentFileNameWithNSString_withNSString_withNSString_(state->segmentInfo_->name_, state->segmentSuffix_, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_TERMS_INDEX_EXTENSION_);
    indexIn = [state->directory_ openInputWithNSString:indexFile withOrgApacheLuceneStoreIOContext:state->context_];
    jint indexVersion = OrgApacheLuceneCodecsCodecUtil_checkIndexHeaderWithOrgApacheLuceneStoreDataInput_withNSString_withInt_withInt_withByteArray_withNSString_(indexIn, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_TERMS_INDEX_CODEC_NAME_, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_VERSION_START, OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter_VERSION_CURRENT, [state->segmentInfo_ getId], state->segmentSuffix_);
    if (indexVersion != version_) {
      @throw [new_OrgApacheLuceneIndexCorruptIndexException_initWithNSString_withOrgApacheLuceneStoreDataInput_(JreStrcat("$@CIC@CI", @"mixmatched version files: ", self->in_, '=', version_, ',', indexIn, '=', indexVersion), indexIn) autorelease];
    }
    ...
    OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_seekDirWithOrgApacheLuceneStoreIndexInput_(self, self->in_);
    OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_seekDirWithOrgApacheLuceneStoreIndexInput_(self, indexIn);
    ...
    for (jint i = 0; i < numFields; i++) {
      ...
      JreAssert((numTerms >= 0), (@"org/apache/lucene/codecs/blocktreeords/OrdsBlockTreeTermsReader.java:119 condition failed: assert numTerms >= 0;"));
      ...
      OrgApacheLuceneCodecsBlocktreeordsFSTOrdsOutputs_Output *rootCode = [((OrgApacheLuceneCodecsBlocktreeordsFSTOrdsOutputs *) nil_chk(JreLoadStatic(OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsWriter, FST_OUTPUTS_))) newOutputWithOrgApacheLuceneUtilBytesRef:code withLong:0 withLong:numTerms];
      ...
      JreAssert((numTerms <= JavaLangInteger_MAX_VALUE), (@"org/apache/lucene/codecs/blocktreeords/OrdsBlockTreeTermsReader.java:128 condition failed: assert numTerms <= Integer.MAX_VALUE;"));
      ...
      OrgApacheLuceneUtilBytesRef *minTerm = OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_readBytesRefWithOrgApacheLuceneStoreIndexInput_(self->in_);
      OrgApacheLuceneUtilBytesRef *maxTerm = OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_readBytesRefWithOrgApacheLuceneStoreIndexInput_(self->in_);
      ...
      OrgApacheLuceneCodecsBlocktreeordsOrdsFieldReader *previous = [self->fields_ putWithId:fieldInfo->name_ withId:[new_OrgApacheLuceneCodecsBlocktreeordsOrdsFieldReader_initWithOrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_withOrgApacheLuceneIndexFieldInfo_withLong_withOrgApacheLuceneCodecsBlocktreeordsFSTOrdsOutputs_Output_withLong_withLong_withInt_withLong_withInt_withOrgApacheLuceneStoreIndexInput_withOrgApacheLuceneUtilBytesRef_withOrgApacheLuceneUtilBytesRef_(self, fieldInfo, numTerms, rootCode, sumTotalTermFreq, sumDocFreq, docCount, indexStartFP, longsSize, indexIn, minTerm, maxTerm) autorelease]];
      if (previous != nil) {
...
OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader *new_OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_initWithOrgApacheLuceneCodecsPostingsReaderBase_withOrgApacheLuceneIndexSegmentReadState_(OrgApacheLuceneCodecsPostingsReaderBase *postingsReader, OrgApacheLuceneIndexSegmentReadState *state) {
  OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader *self = [OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader alloc];
  OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_initWithOrgApacheLuceneCodecsPostingsReaderBase_withOrgApacheLuceneIndexSegmentReadState_(self, postingsReader, state);
  return self;
}

OrgApacheLuceneUtilBytesRef *OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_readBytesRefWithOrgApacheLuceneStoreIndexInput_(OrgApacheLuceneStoreIndexInput *inArg) {
  OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_initialize();
...
void OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader_seekDirWithOrgApacheLuceneStoreIndexInput_(OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader *self, OrgApacheLuceneStoreIndexInput *input) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgApacheLuceneCodecsBlocktreeordsOrdsBlockTreeTermsReader)
