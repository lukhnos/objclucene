...
OrgApacheLuceneIndexIndexWriterConfig *OrgApacheLuceneIndexPKIndexSplitter_newDefaultConfig() {
  ...
  return [((OrgApacheLuceneIndexIndexWriterConfig *) [new_OrgApacheLuceneIndexIndexWriterConfig_initWithOrgApacheLuceneAnalysisAnalyzer_(nil) autorelease]) setOpenModeWithOrgApacheLuceneIndexIndexWriterConfig_OpenModeEnum:JreLoadStatic(OrgApacheLuceneIndexIndexWriterConfig_OpenModeEnum, CREATE)];
}
...
void OrgApacheLuceneIndexPKIndexSplitter_DocumentFilteredLeafIndexReader_initWithOrgApacheLuceneIndexLeafReaderContext_withOrgApacheLuceneSearchWeight_withBoolean_(OrgApacheLuceneIndexPKIndexSplitter_DocumentFilteredLeafIndexReader *self, OrgApacheLuceneIndexLeafReaderContext *context, OrgApacheLuceneSearchWeight *preserveWeight, jboolean negateFilter) {
  OrgApacheLuceneIndexFilterCodecReader_initWithOrgApacheLuceneIndexCodecReader_(self, (OrgApacheLuceneIndexCodecReader *) check_class_cast([((OrgApacheLuceneIndexLeafReaderContext *) nil_chk(context)) reader], [OrgApacheLuceneIndexCodecReader class]));
  jint maxDoc = [((OrgApacheLuceneIndexCodecReader *) nil_chk(self->in_)) maxDoc];
  OrgApacheLuceneUtilFixedBitSet *bits = [new_OrgApacheLuceneUtilFixedBitSet_initWithInt_(maxDoc) autorelease];
  ...
  if ([self->in_ hasDeletions]) {
    ...
    OrgApacheLuceneSearchDocIdSetIterator *it = [new_OrgApacheLuceneUtilBitSetIterator_initWithOrgApacheLuceneUtilBitSet_withLong_(bits, 0LL) autorelease];
