...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgApacheLuceneQueryparserFlexibleCoreConfigAbstractQueryConfig = { 2, "AbstractQueryConfig", "org.apache.lucene.queryparser.flexible.core.config", NULL, 0x401, 1, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
