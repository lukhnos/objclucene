...
#error "org/apache/lucene/analysis/pt/PortugueseAnalyzer must not be compiled with ARC (-fobjc-arc)"
#endif
...
inline OrgApacheLuceneAnalysisUtilCharArraySet *OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder_get_DEFAULT_STOP_SET(void);
...
__attribute__((unused)) static OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder *new_OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder *create_OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder_init(void);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgApacheLuceneAnalysisUtilCharArraySet;", "LOrgApacheLuceneAnalysisUtilCharArraySet;LOrgApacheLuceneAnalysisUtilCharArraySet;", "createComponents", "LNSString;", &OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DEFAULT_STOPWORD_FILE, "LOrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder;" };
  static const J2ObjcClassInfo _OrgApacheLuceneAnalysisPtPortugueseAnalyzer = { "PortugueseAnalyzer", "org.apache.lucene.analysis.pt", ptrTable, methods, fields, 7, 0x11, 5, 2, -1, 5, -1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { &OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder_DEFAULT_STOP_SET, "LOrgApacheLuceneAnalysisPtPortugueseAnalyzer;" };
  static const J2ObjcClassInfo _OrgApacheLuceneAnalysisPtPortugueseAnalyzer_DefaultSetHolder = { "DefaultSetHolder", "org.apache.lucene.analysis.pt", ptrTable, methods, fields, 7, 0xa, 1, 1, 1, -1, -1, -1, -1 };
