...
- (OrgApacheLuceneAnalysisCharFilter *)createWithJavaIoReader:(JavaIoReader *)input {
  return [new_OrgApacheLuceneAnalysisFaPersianCharFilter_initWithJavaIoReader_(input) autorelease];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithJavaUtilMap:", "PersianCharFilterFactory", NULL, 0x1, NULL, NULL },
