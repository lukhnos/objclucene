...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgApacheLuceneAnalysisHiHindiNormalizer = { 2, "HindiNormalizer", "org.apache.lucene.analysis.hi", NULL, 0x1, 1, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
