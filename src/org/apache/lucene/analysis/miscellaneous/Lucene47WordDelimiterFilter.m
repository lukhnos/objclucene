...
- (jboolean)incrementToken {
  while (YES) {
    ...
    if ([iterator_ isSingleWord]) {
      OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_generatePartWithBoolean_(self, YES);
      [iterator_ next];
      return YES;
    }
    ...
    if (OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_shouldGeneratePartsWithInt_(self, wordType)) {
      OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_generatePartWithBoolean_(self, NO);
      [iterator_ next];
      return YES;
    }
    [iterator_ next];
...
void OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_generatePartWithBoolean_(OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter *self, jboolean isSingleWord) {
  ...
  [((id<OrgApacheLuceneAnalysisTokenattributesPositionIncrementAttribute>) nil_chk(self->posIncAttribute_)) setPositionIncrementWithInt:OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_positionWithBoolean_(self, NO)];
...
- (void)write {
  ...
  [((id<OrgApacheLuceneAnalysisTokenattributesPositionIncrementAttribute>) nil_chk(this$0_->posIncAttribute_)) setPositionIncrementWithInt:OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_positionWithBoolean_(this$0_, YES)];
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithOrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter:", "init", NULL, 0x0, NULL, NULL },
  };
  static const J2ObjcFieldInfo fields[] = {
...
OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_WordDelimiterConcatenation *new_OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_WordDelimiterConcatenation_initWithOrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_(OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter *outer$) {
  OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_WordDelimiterConcatenation *self = [OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_WordDelimiterConcatenation alloc];
  OrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_WordDelimiterConcatenation_initWithOrgApacheLuceneAnalysisMiscellaneousLucene47WordDelimiterFilter_(self, outer$);
  return self;
}
