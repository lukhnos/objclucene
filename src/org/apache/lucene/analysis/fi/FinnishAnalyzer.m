...
#error "org/apache/lucene/analysis/fi/FinnishAnalyzer must not be compiled with ARC (-fobjc-arc)"
#endif
...
inline OrgApacheLuceneAnalysisUtilCharArraySet *OrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder_get_DEFAULT_STOP_SET(void);
...
__attribute__((unused)) static OrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder *new_OrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder_init(void) NS_RETURNS_RETAINED;

__attribute__((unused)) static OrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder *create_OrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder_init(void);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOrgApacheLuceneAnalysisUtilCharArraySet;", "LOrgApacheLuceneAnalysisUtilCharArraySet;LOrgApacheLuceneAnalysisUtilCharArraySet;", "createComponents", "LNSString;", &OrgApacheLuceneAnalysisFiFinnishAnalyzer_DEFAULT_STOPWORD_FILE, "LOrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder;" };
  static const J2ObjcClassInfo _OrgApacheLuceneAnalysisFiFinnishAnalyzer = { "FinnishAnalyzer", "org.apache.lucene.analysis.fi", ptrTable, methods, fields, 7, 0x11, 5, 2, -1, 5, -1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { &OrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder_DEFAULT_STOP_SET, "LOrgApacheLuceneAnalysisFiFinnishAnalyzer;" };
  static const J2ObjcClassInfo _OrgApacheLuceneAnalysisFiFinnishAnalyzer_DefaultSetHolder = { "DefaultSetHolder", "org.apache.lucene.analysis.fi", ptrTable, methods, fields, 7, 0xa, 1, 1, 1, -1, -1, -1, -1 };
