...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "init", "BulkOperationPacked23", NULL, 0x1, NULL, NULL },
  ...
  static const J2ObjcClassInfo _OrgApacheLuceneUtilPackedBulkOperationPacked23 = { 2, "BulkOperationPacked23", "org.apache.lucene.util.packed", NULL, 0x10, 5, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_OrgApacheLuceneUtilPackedBulkOperationPacked23;
}

@end

void OrgApacheLuceneUtilPackedBulkOperationPacked23_init(OrgApacheLuceneUtilPackedBulkOperationPacked23 *self) {
  OrgApacheLuceneUtilPackedBulkOperationPacked_initWithInt_(self, 23);
}
