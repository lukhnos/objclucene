...
#error "org/apache/lucene/util/packed/BulkOperationPacked7 must not be compiled with ARC (-fobjc-arc)"
#endif

@implementation OrgApacheLuceneUtilPackedBulkOperationPacked7

- (instancetype)initPackagePrivate {
  OrgApacheLuceneUtilPackedBulkOperationPacked7_initPackagePrivate(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgApacheLuceneUtilPackedBulkOperationPacked7 = { "BulkOperationPacked7", "org.apache.lucene.util.packed", ptrTable, methods, NULL, 7, 0x10, 5, 0, -1, -1, -1, -1, -1 };
  return &_OrgApacheLuceneUtilPackedBulkOperationPacked7;
}

@end

void OrgApacheLuceneUtilPackedBulkOperationPacked7_initPackagePrivate(OrgApacheLuceneUtilPackedBulkOperationPacked7 *self) {
  OrgApacheLuceneUtilPackedBulkOperationPacked_initPackagePrivateWithInt_(self, 7);
}

OrgApacheLuceneUtilPackedBulkOperationPacked7 *new_OrgApacheLuceneUtilPackedBulkOperationPacked7_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgApacheLuceneUtilPackedBulkOperationPacked7, initPackagePrivate)
}

OrgApacheLuceneUtilPackedBulkOperationPacked7 *create_OrgApacheLuceneUtilPackedBulkOperationPacked7_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgApacheLuceneUtilPackedBulkOperationPacked7, initPackagePrivate)
}
