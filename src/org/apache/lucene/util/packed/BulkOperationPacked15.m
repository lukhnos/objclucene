...
#error "org/apache/lucene/util/packed/BulkOperationPacked15 must not be compiled with ARC (-fobjc-arc)"
#endif

@implementation OrgApacheLuceneUtilPackedBulkOperationPacked15

- (instancetype)initPackagePrivate {
  OrgApacheLuceneUtilPackedBulkOperationPacked15_initPackagePrivate(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _OrgApacheLuceneUtilPackedBulkOperationPacked15 = { "BulkOperationPacked15", "org.apache.lucene.util.packed", ptrTable, methods, NULL, 7, 0x10, 5, 0, -1, -1, -1, -1, -1 };
  return &_OrgApacheLuceneUtilPackedBulkOperationPacked15;
}

@end

void OrgApacheLuceneUtilPackedBulkOperationPacked15_initPackagePrivate(OrgApacheLuceneUtilPackedBulkOperationPacked15 *self) {
  OrgApacheLuceneUtilPackedBulkOperationPacked_initPackagePrivateWithInt_(self, 15);
}

OrgApacheLuceneUtilPackedBulkOperationPacked15 *new_OrgApacheLuceneUtilPackedBulkOperationPacked15_initPackagePrivate() {
  J2OBJC_NEW_IMPL(OrgApacheLuceneUtilPackedBulkOperationPacked15, initPackagePrivate)
}

OrgApacheLuceneUtilPackedBulkOperationPacked15 *create_OrgApacheLuceneUtilPackedBulkOperationPacked15_initPackagePrivate() {
  J2OBJC_CREATE_IMPL(OrgApacheLuceneUtilPackedBulkOperationPacked15, initPackagePrivate)
}
